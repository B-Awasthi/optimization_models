...
"""This model is implementation of factory planning 1 problem [example #3]
   listed in fifth edition of Modeling Building in Mathematical Programming
   by H. P. Williams on pages 255 – 256 and 300 – 302
...
# model instantiation
model = pywraplp.Solver("factory_planning_1", pywraplp.Solver.GLOP_LINEAR_PROGRAMMING)
...
for mth in months:
    for mach in machines:
        model.Add(
            ...
            <= hours_per_month
            * (machines_installed[mach] - machines_down.get((mth, mach), 0))
        )
